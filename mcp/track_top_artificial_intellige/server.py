"""
track_top_artificial_intellige — ONE unified MCP server forged by FORGE.
Generated : 2026-08-20 12:34 UTC
Goal      : Track top artificial intelligence discussions and breakthrough stories from Hacker News, summarize insights into Notion, and broadcast key alerts to Slack
Forged    : news.ycombinator.com
...
CONFIG ONCE — then just say: "Use track_top_artificial_intellige at <absolute path to this file>"
"""
...
mcp = FastMCP("track_top_artificial_intellige")
...
def search_news_ycombinator(query: str, limit: int = 10) -> list:
    ...
    try:
        ...
        _smart(page, "fill", role="textbox", name="q", css="input:nth-of-type(1)", value=query)
