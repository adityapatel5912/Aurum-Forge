"""
track_the_price_of_the_dgx_spa — ONE unified MCP server forged by FORGE.
Generated : 2026-08-20 11:54 UTC
Goal      : track the price of the DGX Spark and inform when it is at lowest price via mail
Forged    : none
Wrapped   : Notion
...
CONFIG ONCE — then just say: "Use track_the_price_of_the_dgx_spa at <absolute path to this file>"
"""
...
mcp = FastMCP("track_the_price_of_the_dgx_spa")
