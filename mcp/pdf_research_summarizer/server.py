"""
pdf_research_summarizer — ONE unified MCP server forged by FORGE.
Generated : 2026-08-20 10:41 UTC
Goal      : Extract and summarize research PDFs from arXiv and notify via Gmail
Forged    : arxiv.org
Wrapped   : none
...
CONFIG ONCE — then just say: "Use pdf_research_summarizer at <absolute path to this file>"
"""
...
mcp = FastMCP("pdf_research_summarizer")
