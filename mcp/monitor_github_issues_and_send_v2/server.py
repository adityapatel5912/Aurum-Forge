"""
monitor_github_issues_and_send_v2 — ONE unified MCP server forged by FORGE.
...
CONFIG ONCE — then just say: "Use monitor_github_issues_and_send_v2 at <absolute path to this file>"
"""
...
mcp = FastMCP("monitor_github_issues_and_send_v2")
