"""
docker_devops_manager — ONE unified MCP server forged by FORGE.
Generated : 2026-08-20 10:41 UTC
Goal      : Inspect docker containers, tail logs, and send alerts to Slack
Forged    : none
Wrapped   : Slack
...
CONFIG ONCE — then just say: "Use docker_devops_manager at <absolute path to this file>"
"""
...
mcp = FastMCP("docker_devops_manager")
