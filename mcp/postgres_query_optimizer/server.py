"""
postgres_query_optimizer — ONE unified MCP server forged by FORGE.
Generated : 2026-08-20 10:41 UTC
Goal      : Analyze slow Postgres queries and log recommendations to Notion
Forged    : none
Wrapped   : Notion
...
CONFIG ONCE — then just say: "Use postgres_query_optimizer at <absolute path to this file>"
"""
...
mcp = FastMCP("postgres_query_optimizer")
