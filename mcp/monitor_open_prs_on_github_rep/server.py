...
CONFIG ONCE — then just say: "Use monitor_open_prs_on_github_rep at <absolute path to this file>"
"""
...
mcp = FastMCP("monitor_open_prs_on_github_rep")
