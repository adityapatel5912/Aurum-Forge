"""
ram_tracker_v2 — ONE unified MCP server forged by FORGE.
...
CONFIG ONCE — then just say: "Use ram_tracker_v2 at <absolute path to this file>"
"""
