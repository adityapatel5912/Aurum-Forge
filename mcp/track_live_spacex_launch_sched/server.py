"""
track_live_spacex_launch_sched — ONE unified MCP server forged by FORGE.
Generated : 2026-08-20 11:47 UTC
Goal      : Track live SpaceX launch schedule and notify engineering team via Slack
Forged    : spaceflightnow.com
Wrapped   : Slack
...
CONFIG ONCE — then just say: "Use track_live_spacex_launch_sched at <absolute path to this file>"
"""
...
mcp = FastMCP("track_live_spacex_launch_sched")
...
def search_spaceflightnow(query: str, limit: int = 10) -> list:
    ...
    try:
        ...
        _smart(page, "fill", role="searchbox", name="s", css="input.search-field", value=query)
