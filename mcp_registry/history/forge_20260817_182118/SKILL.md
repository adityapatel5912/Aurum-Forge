---
name: unified-forge
description: Find hackathons and log to Google Sheets
version: 1.0.0
mcp: unified-forge
---

# Skill: Find hackathons and log to Google Sheets

## Overview
This skill executes: Find hackathons and log to Google Sheets
...
```json
{
  "T1": {
    ...
    "source": "Custom devpost.com Forged"
  },
  "T2": {
    "tool": "mlh_get_events",
    "source": "Custom mlh.io Forged",
    "deps": [
      "T1"
    ]
  }
...
## When to Invoke
User says: "Find hackathons and log to Google Sheets" or similar to RAM/hackathon/tee tracking
