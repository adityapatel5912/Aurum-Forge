...
if command -v claude &> /dev/null; then
    claude mcp add chain_research -- python "/app/mcp_registry/servers/chain_research/server.py" || true
    echo "  [OK] Claude Code configured successfully."
fi

if command -v codex &> /dev/null; then
    codex mcp add chain_research -- python "/app/mcp_registry/servers/chain_research/server.py" || true
    echo "  [OK] Codex configured successfully."
fi

if command -v opencode &> /dev/null; then
    opencode mcp add chain_research -- python "/app/mcp_registry/servers/chain_research/server.py" || true
